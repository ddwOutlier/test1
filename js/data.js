const qnaList = [
  {
    ...
    a: [
      { answer: 'a. 아련한 눈빛을 보내며 다음을 기약한다.', type: ['shadowgam','shygam','gamja'] },
      { answer: 'b. 미쳤나봐, 카메라를 켜고 인파 속으로 뛰어들어간다.', type: ['ssgam','burngam'] },
    ]
  },
  {
    q: '2. 랩실에 갔더니 동기가 울고 있다. "4시간째 코드짰는데, 갑자기 컴퓨터 전원이 꺼졌어,,"',
    a: [
      { answer: 'a. 헉 괜찮아? 어떡해,, 급한거야? 마이쮸(or 술) 먹을래?', type: ['ssgam','unigam','shygam','gamja'] },
    ...
    a: [
      { answer: 'a. 그거 데이터 없을걸요? 이건 구현 힘들거 같은데,, 하나하나 실현 가능성 따지는 팀원 ', type: ['ssgam','shadowgam','shygam'] },
      { answer: 'b. 오 좋아요. 헐 대박 좋은데요? 전 다 좋아요! 무슨 말을 해도 좋다고 하는 팀원', type: ['burngam','unigam','gamja'] },
    ]
  },
    {
    q: '4. 프로젝트 진행 시, 당신이 주로 사용하는 것은?',
    a: [
      { answer: 'a. 선례연구에서 많이 활용한 모델', type: ['ssgam','unigam','gamja'] },
      { answer: 'b. 발표된 지 얼마 안된 핫한 트렌드 모델', type: ['burngam','shadowgam','shygam'] },
    ]
  },
  {
    q: '5. 인문관 복도에서 모르는 사람이 나한테 인사한다. 이때 나는?',
    a: [
      { answer: 'a. 나,,? 아니겠지? 못본 척 한다.', type: ['shadowgam','shygam','gamja']},
      { answer: 'b. 아는 사람인가? 당황스럽지만 인사해준다.', type: ['ssgam','burngam']},
    ]
  },
   {
    q: '6. 더 선호하는 전공 강의는? (둘 다 학점은 후하다는 전제!)',
    a: [
      { answer: 'a. "일단 들어두면 나중에 찾아서라도 쓸 수 있어요~" 배우는 건 많고 도움이 될 거 같지만 어려운 강의', type: ['burngam','shadowgam','gamja','unigam'] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 아무 생각 없다.', type: ['burngam','shadowgam','gamja'] },
